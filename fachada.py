...
class BancoFacade:
    ...
    def __init__(self, numero_cuenta: int, codigo_seguridad: int):
        ...
        self.usuario = self.check_numero_cuenta.validar_numero_cuenta(self.numero_cuenta)
    ...
    def retirar_dinero(self, valor: float):
        if (self.check_numero_cuenta.validar_numero_cuenta(self.numero_cuenta)[0] and self.check_codigo_seguridad.validar_codigo_seguridad(self.codigo_seguridad)):
